  ...
  return (
    <div className="container">
      ...
      <main>
        ...
        <ul className="faqs">
          <li id="location">
            <p className="question">Where is the wedding taking place?<Link href="/faq">🔝</Link></p>
            <p className="answer">At the <a href="https://goo.gl/maps/Ge6i28KAUbpqtEdU7">Ypsilanti Freighthouse, 100 Market Pl, Ypsilanti, MI 48198</a></p>
          </li>
          <li id="schedule">
            <p className="question">What time is the ceremony? What time is the reception?<Link href="/faq">🔝</Link></p>
            <p className="answer">We’re starting the celebration with dinner! There will be a short cocktail “hour” beginning at 5:15 with drinks and appetizers. Please plan to be seated at your dinner table no later than 6:00pm. Dinner will be followed directly by the ceremony. Then we’ll transition to dessert, coffee, drinks and dancing! Please refer to this <Link href="/#schedule">timeline</Link> if needed.</p>
          </li>
          <li id="dresscode">
            <p className="question">What is the dress code? What should I wear? Is there a theme?<Link href="/faq">🔝</Link></p>
            <p className="answer">We don’t have a theme or official wedding colors or anything like that. Attire is semi-formal. Dylan and Elizabeth value fun and creativity over convention. Vintage, non-traditional, very traditional, gender-queer outfits are all encouraged. The more memorable you can make this for us, the better!</p>
          </li>
          <li id="weather">
            <p className="question">What weather should I expect?<Link href="/faq">🔝</Link></p>
            <p className="answer">Of course, we can’t guarantee anything, but June can sometimes be hot and humid in Michigan. Plan for warm weather but be prepared for it to cool off later in the evening.</p>
          </li>
          <li id="indoor">
            <p className="question">Will the wedding be indoors or outdoors?<Link href="/faq">🔝</Link></p>
            <p className="answer">The wedding and reception will be indoors. As a result, proof of vaccination will be required for all. That said, we are making sure that the event will have excellent ventilation, to ensure everyone’s safety. You can read more about it in the FAQ below regarding COVID health and safety protocols.</p>
          </li>
          <li id="transportation">
            <p className="question">Will transportation be provided? Is there easy parking at the venue(s)?<Link href="/faq">🔝</Link></p>
          ...
          <li id="rsvpdeadline">
            <p className="question">When is the RSVP deadline?<Link href="/faq">🔝</Link></p>
            <p className="answer">Please get us your RSVP by June 3rd, so we have time to buy enough booze.</p>
          </li>
          <li id="kids">
            <p className="question">Can I bring my kids? Will there be a babysitter?<Link href="/faq">🔝</Link></p>
          ...
          <li id="plusone">
            <p className="question">Can I bring my partner/spouse/romantic other?<Link href="/faq">🔝</Link></p>
            <p className="answer">Yes please! Just make sure we know how many people you are RSVPing.</p>
          </li>
          <li id="virtual">
            <p className="question">I can’t attend the wedding in person. Will there be a virtual wedding celebration?<Link href="/faq">🔝</Link></p>
          ...
          <li id="hotel">
            <p className="question">Do you have a hotel block for guests? Where do you recommend I stay?<Link href="/faq">🔝</Link></p>
          ...
          <li id="accessibility">
            <p className="question">Are the ceremony and reception location wheelchair accessible?<Link href="/faq">🔝</Link></p>
            <p className="answer">Yes!</p>
          </li>
          <li id="food">
            <p className="question">What type of food and drink will be served during the cocktail hour and reception?<Link href="/faq">🔝</Link></p>
          ...
          <li id="diet">
            <p className="question">I have dietary restrictions, what’s the best way to communicate that with you?<Link href="/faq">🔝</Link></p>
          ...
          <li id="bar">
            <p className="question">Will there be an open bar?<Link href="/faq">🔝</Link></p>
            <p className="answer">Yes, please tip your bartender!</p>
          </li>
          <li id="registry">
            <p className="question">Are you registered? Where should we ship your gift?<Link href="/faq">🔝</Link></p>
            <p className="answer">We are not. If you want to give us a gift these are three contributions we would appreciate:</p>
            <ol>
              <li>
                <h3>Help us decorate our wedding and our house with pictures of you</h3>
                <p className="answer">The only physical object we would like to receive is a framed picture of you with one or both of us. This event is all about celebrating our communities, and as a result, we want the main decor to be framed pictures of the attendees. After the event, we are planning to dedicate a wall of our house with these pictures, as a reminder of our loved ones.</p>
                <p className="answer">Even if you can’t attend the wedding, we would love to have your picture be part of the event and of our wall. You can either bring the picture <i>with no wrapping</i> to the wedding, or you can mail it to the following address (just make sure it arrives before June 24th):
                  <blockquote>
              ...
              <li>
                ...
                <p className="answer">While individual actions by themselves are not a sufficient solution to the climate change crisis, they can reframe our assumptions and expectations about life on this planet, which in turn can help drive more sweeping and collective changes. We are attempting to reduce the carbon footprint of our event as much as possible, but guests traveling from afar is an inherent challenge.</p>
                <p className="answer">If you'd like to help offset your climate impact while attending this event, please consider purchasing carbon offsets for your travel. There are lots of resources online for calculating your carbon footprint and purchasing offsets, but here are a few:
          ...
          <li id="pictures">
            <p className="question">You want me to bring/ship you a framed picture? Can you be more specific about this?<Link href="/faq">🔝</Link></p>
            <p className="answer">Yes, thank you for asking. Ideally we would like for the frame to be black or silver, in any size up to 8x10. As far as the picture itself goes, we want to make sure that we can see your face (you’re the most important person in this picture), and hopefully one of the people getting married. We’re more than happy to have these pictures be silly or old, but we will settle for any presentable picture featuring a guest with one of the people getting married.</p>
          </li>
          <li id="social">
            <p className="question">Can I take and post pictures of the wedding on social media?<Link href="/faq">🔝</Link></p>
            <p className="answer">We’d prefer that you didn’t. This is a rare chance for so many of us to gather together in one place, and we want to take that opportunity to appreciate and be present with each other during the event. We don’t want posts on social media strengthening the bad feelings of missing out for those that can’t be with us at the wedding.</p>
            ...
            <p className="answer"><a href="https://www.lecindaward.com.au/journal/2018/the-benefits-of-an-unplugged-wedding-ceremony">https://www.lecindaward.com.au/journal/2018/the-benefits-of-an-unplugged-wedding-ceremony</a></p>
          </li>
          <li id="covid">
            <p className="question">What COVID health and safety measures will you be taking during the event?<Link href="/faq">🔝</Link></p>
